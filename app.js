...
function searcher(){
    ...
    loadData(search, function(evt){
        ...
        for (let i = 0; i < result['docs'].length; i++) {
            ...
            films.innerHTML += `<div class="film"><div class="card"><div class="poster"><img src="${result['docs'][i]['poster']}" alt="poster" id="miniPoster"></div><div class="info"><h3 id="name">${result['docs'][i]['name']}</h3><br><h3 id="year">2015</h3><button class="details" id="${i}">Details</button></div></div></div>`
            }
        }
    });  
}